...
if __name__ == '__main__':
    ...
    with open(str(options.input), 'r') as input:
        ...
        for feature in features:
            ...
            import_props['ol:concordances'] = {}
            import_props['ol:country'] = "CA"
            import_props['ol:date_modified'] = int(time.time())
            import_props['ol:land_designation'] = props['feat_desc']
            import_props['ol:name'] = props['name']
            import_props['ol:note'] = ""

            if str(props['feat_desc']).startswith('National'):
                import_props['ol:managing_agency'] = "Parks Canada"
                import_props['ol:managing_agency_level'] = "National"

            else:
                import_props['ol:managing_agency'] = "Nova Scotia Department of Natural Resources"
