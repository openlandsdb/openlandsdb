...
if __name__ == '__main__':
    ...
    with open(str(options.input), 'r') as input:
        ...
        for feature in features:
            ...
            import_props['ol:concordances'] = {"nps:gnis_id":int(props['GNIS_ID'])}
            import_props['ol:country'] = "US"
            import_props['ol:date_modified'] = int(time.time())
            import_props['ol:land_designation'] = props['UNIT_TYPE']
            import_props['ol:name'] = props['UNIT_NAME']
            import_props['ol:note'] = ""
            import_props['ol:managing_agency'] = "National Park Service"
